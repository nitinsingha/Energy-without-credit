...
m = 60;        % Number of buyers
n = 30;        % Number of sellers

S = zeros(1, 60);   %selling price matrix
B = zeros(60, 30);   %buying price matrix
...
%Constants
epsi = 0.01;                % Convergence criterion parameter
