...
% The seller in double auction doesn't receive money based on its bid. It receives money based on its rewars.
% While seller in first come first receive money based on its reward.
% Therefore we have used rewd for calculating DSO_reward_ratio, but lateron selling price is udsed for further calculation 
